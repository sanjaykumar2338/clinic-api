...
class InventoryController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $items = Material::where('is_deleted',0)->where('stock_type','general')->where('clinic_id',$request->user()->clinic_id)->select('mcl_material.description as name','mcl_material.available_stock as quantity')->get();
